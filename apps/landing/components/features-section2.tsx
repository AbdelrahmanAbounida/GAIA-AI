...
import { ProviderIcon } from "../../web/components/modals/credential-modal/provider-icons";
...
export function StorageCard() {
  ...
  return (
    <div className="group h-full min-h-70 rounded-xl border dark:border-gaia-700 dark:bg-gaia-950 p-6 transition-all duration-300 dark:hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5">
      <div className="flex items-center gap-2 mb-2">
