    ...
    variants: {
      variant: {
        ...
        brand: cn(
          ...
          "bg-brand-700",
          "dark:bg-brand-900! dark:hover:bg-brand-800/90! dark:hover:border-brand-500! dark:data-[state=open]:bg-brand-500/80! dark:border-brand-400/30! hover:border-brand-600! data-[state=open]:bg-brand-400/80!",
          ""
        ),
        secondary:
        ...
        ghost:
          "bg-gaia-100  border-none text-accent-foreground hover:bg-accent/90",
      },
    },
    defaultVariants: {
      variant: "default",
