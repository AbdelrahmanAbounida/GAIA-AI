  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-11 dark:h-9 w-full rounded-md border  dark:bg-transparent px-3 py-1 ",
          ...
          "dark:bg-gaia-950 bg-gaia-200 border-gaia-300 dark:border-gaia-700! dark:focus:bg-gaia-800! hover:bg-gaia-200/90 dark:hover:bg-gaia-800 ring-0! focus-visible:ring-0! focus-visible:ring-offset-0! focus-visible:ring-offset-transparent! text-black dark:text-white",
          className
        )}
        ref={ref}
        {...props}
