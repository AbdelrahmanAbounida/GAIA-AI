...
>(({ className, inset, isActive, children, ...props }, ref) => (
  ...
  >
    {isActive && (
      <CheckIcon className=" w-4 h-4 text-white bg-brand-500 dark:bg-brand-600 rounded-full" />
    )}
    {children}
  </DropdownMenuPrimitive.Item>
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-4 w-4 border focus:outline-none! focus:ring-0!  p-1 rounded-full items-center justify-center ">
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-gaia-300 dark:bg-gaia-700", className)}
    {...props}
  />
));
